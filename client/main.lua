...
local CheckAuth = function(doorData)
    ...
    if doorData.items then
        QBCore.Functions.TriggerCallback('nui_doorlock:server:CheckItems', function(result)
            ...
            while true do
                ...
                elseif paused then
                    ...
                    if closestDoor.distance < closestDoor.data.maxDistance then
                        ...
                        if not closestDoor.data.locked and canOpen then
                            ...
                            exports['qb-radialmenu']:AddOption(5, {
								...
								icon = 'door-open',
								type = 'client',
								event = 'nui_doorlock:client:togglelock',
								shouldClose = true
							})
...
local PlaySound = function(door, src, enableSounds)
            ...
            if Config.DoorList[doorID].doors then
                for k, v in pairs(Config.DoorList[doorID].doors) do
                    ...
                    elseif not Config.DoorList[doorID].locked then
                        ...
                        if QBCore.Shared.Round(v.currentHeading, 0) == QBCore.Shared.Round(v.objHeading, 0) then
                ...
                elseif not Config.DoorList[doorID].locked then
                    ...
                    if QBCore.Shared.Round(Config.DoorList [doorID].currentHeading, 0) == QBCore.Shared.Round(Config.DoorList[doorID].objHeading, 0) then
...
RegisterNetEvent('nui_doorlock:client:togglelock', function()
	exports['qb-radialmenu']:RemoveOption(5)
